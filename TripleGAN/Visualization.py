...
def obtain_embedding_feature_map(netA, test_dataloader):
    netA.eval()
    ...
    with torch.no_grad():
        ...
        for data, target in test_dataloader:
            ...
            feature_map[len(feature_map):len(output_of_netA[0])-1] = output_of_netA[0].tolist()
...
def main():
    ...
    model = torch.load("model_weight/netA_n_classes_10_label10_unlabel90_rand30.pth")
    ...
    scatter(eval_tsne_embeds, target.astype('int64'), "TripleGAN_n_classes_10_label10_unlabel90", 10)
    visualize_data(X_test_embedding_feature_map, target.astype('int64'), "Visualization/TripleGAN_n_classes_10_10label_90unlabel_improved", 10)
