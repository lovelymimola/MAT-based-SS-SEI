...
def main():
    ...
    model = torch.load("model_weight/encoder_complex_n_classes_10_label10_unlabel90_rand30.pth")
    ...
    scatter(eval_tsne_embeds, target.astype('int64'), "DRCN_complex_n_classes_10_label10_unlabel90", 10)
    visualize_data(X_test_embedding_feature_map, target.astype('int64'), "Visualization/DRCN_complex_n_classes_10_10label_90unlabel_improved", 10)
