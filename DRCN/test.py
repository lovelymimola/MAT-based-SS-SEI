...
def main():
    ...
    encoder = torch.load('model_weight/encoder_complex_n_classes_10_label100_unlabel0_rand30.pth')
    classifier = torch.load('model_weight/classifier_complex_n_classes_10_label100_unlabel0_rand30.pth')
