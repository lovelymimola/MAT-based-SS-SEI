...
def main():
    ...
    model = torch.load('model_weight/CNN_MAT1_n_classes_10_10label_90unlabel_rand30_Split3_autoweight100.pth')
    ...
    scatter(eval_tsne_embeds, target.astype('int64'), "CNN_MAT_n_classes_10_10label_90unlabel", 10)
