...
def main():
    ...
    model = torch.load("model_weight/SSRCNN_n_classes_10_10label_90unlabel_rand30.pth")
    ...
    scatter(eval_tsne_embeds, target.astype('int64'), "SSRCNN_n_classes_10_10label_90unlabel", 10)
    visualize_data(X_test_embedding_feature_map, target.astype('int64'), "Visualization/SSRCNN_n_classes_10_10label_90unlabel_improved", 10)
